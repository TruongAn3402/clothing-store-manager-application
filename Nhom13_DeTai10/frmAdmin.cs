...
namespace Nhom13_DeTai10
{
    public partial class frmAdmin : Form
    {
        ...
        public frmAdmin()
        {
            string sql_ketnoi = @"Data Source =LAPTOP-EH1UPPUL\SQLEXPRESS; Initial Catalog = QL_ShopQuanAo; User ID = sa; Password = sa2012"; //123
        ...
        private void btnKhachHang_XoaBoLoc_Click(object sender, EventArgs e)
        {
            ...
            txtKhachHang_Ten.ResetText();
            txtKhachHang_SDT.ResetText();
            txtKhachHang_DiaChi.ResetText();
        }
